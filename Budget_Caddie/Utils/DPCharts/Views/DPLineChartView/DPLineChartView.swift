...
open class DPLineChartView: DPCanvasView {
    ...
    @IBInspectable
    open var yAxisShiftPercentage: CGFloat = 0.02 {
        didSet {
            setNeedsLayout()
        }
    }
    ...
    func initPoints() {
        ...
        for i in 0..<numberOfLines {
            ...
            for j in 0..<numberOfPoints {
                ...
                points[i].insert(DPLinePoint(x: xAxisPosition, y: yAxisPosition + 2, lineIndex: i, index: j), at: j)
            }
        }
    }
