...
class TextyTabBarController: UITabBarController, UITabBarControllerDelegate {
    ...
    public var customSelectedTabIndex: Int = 0
    ...
    override func viewDidLayoutSubviews() {
        ...
        indexView.backgroundColor = buttonsColors[customSelectedTabIndex]
    }
    ...
    private func autolayout() {
        ...
        indexViewCenterXAnchor = indexView.centerXAnchor.constraint(equalTo: buttons[customSelectedTabIndex].centerXAnchor)
        indexViewCenterXAnchor.isActive = true
        
        indexViewWidthAnchor = indexView.widthAnchor.constraint(equalTo: buttons[customSelectedTabIndex].widthAnchor, constant: -20)
    ...
    @objc private func didSelectIndex(sender: UIButton) {
        ...
        if index == self.selectedIndex {
            ...
            self.customSelectedTabIndex = index
